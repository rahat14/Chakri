...
?>
    ...
    if (isset($_GET['edit_job_circular'])) {
        ...
        $share_text = $row_edit['share_text'];
                ...
                <div class="card-body  pad">
                    ...
                    <form class="form-horizontral" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-md-6 control-label">Update Text For Share Button : </label>

                            <div class="col-md-12">

                                <textarea type="text" name="share_text" 
                                cols=8 rows=8
                                class="form-control" required placeholder="Add Text"><?php echo $share_text; ?></textarea>
    ...
    if (isset($_POST['submit'])) {
        ...
        $insert_store = "UPDATE  job_circular_db  set  title =  '$store_title'  ,image  ='$store_image'  ,pdf ='$circular_pdf' ,description ='$store_desc' , cat_id ='$store_merchant_id' , sub_cat_id  = $p_SUB_cat_id  , keywords ='$keywords'  , image2 = '$store_image2' , image3 = '$store_image3' , rank = $rank , share_text = '$share_text' where  id = $edit_id";
