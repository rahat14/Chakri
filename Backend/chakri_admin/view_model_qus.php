                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td> <button type="button " class="btn btn-info" data-toggle="modal" data-target="#modal-edit-<?php echo $id; ?>">
                                                    Edit
                                                </button>

                                                <div class="modal fade" id="modal-edit-<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                    >
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form class="form-horizontral" action="" method="post" enctype="multipart/form-data">
                                                                    ...
                                                                    <input value=<?php echo  '"' . $title . '"';  ?> type="text" name="qus" class="form-control" required>
                                                                    <br>
                                                                    <div class="row  justify-content-center align-items-center h-100">
                                                                        <div class="column">
                                                                            <input value=<?php echo '"' . $op1 . '"';  ?> name="op1" class="form-control" required>
                                                                            &nbsp
                                                                            <input value=<?php echo '"' . $op2 . '"';  ?> name="op2" class="form-control" required>
                                                                        </div>
                                                                        &nbsp &nbsp
                                                                        <div class="column">

                                                                            <input value=<?php echo '"' . $op3 . '"';  ?> name="op3" class="form-control" required>
                                                                            &nbsp
                                                                            <input value=<?php echo '"' . $op4 . '"';  ?> name="op4" class="form-control" required>

                                                                        </div>
                                                                        <div class="column">
                                                                            &nbsp
                                                                            <input value=<?php echo '"' . $op5 . '"';  ?> name="op5" class="form-control" placeholder="Option-D (Bank Only)">

                                                                        </div>
                                                                    </div>
                                                                    <br>
                                                                    <input value=<?php echo '"' . $ans . '"';  ?> name="ans" class="form-control" required>
                                ...
                                <div class="modal-body">
                                    ...
                                    <form class="form-horizontral" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row  justify-content-center align-items-center h-100">
                                            ...
                                            <div class="column">
                                                &nbsp
                                                <input  name="op5" class="form-control" placeholder="Option-D (Bank Only)">
...
if (isset($_POST['submit'])) {
    ...
    $insertion_Query = "INSERT INTO model_question_db (qustion_id,title,option_one, option_two, option_three, option_four , option_five , right_ans , post_type) VALUES ($q_id , '$qus' ,'$op1','$op2','$op3','$op4','$op5' , '$ans',700)";
