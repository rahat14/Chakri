...
?>
  ...
  <script>
                        ...
                        <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea type="text" rows="10" cols="10" name="share_text" class="form-control" required placeholder="Add Text"></textarea>
    ...
    if (isset($_POST['submit'])) {
        ...
        $insert_store = "insert into job_circular_db (title ,image,pdf ,description , cat_id , sub_cat_id ,date , keywords , image2 ,image3 , rank , share_text , post_type ) values ('$store_title','$store_image', '$circular_pdf','$store_desc' , '$store_merchant_id',  $sub_Cateogry ,'$date' , '$keywords' , '$store_image2' , '$store_image3' , 100, '$share_text' , 666 )";
