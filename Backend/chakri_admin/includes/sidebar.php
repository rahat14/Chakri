            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
               ...
               with font-awesome or any other icon font library -->
                            ...
                            <!-- <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="index.php?view_p_cats" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>View Category</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="index.php?view_model_qus_list" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Model Qustion list </p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="index.php?add_model_qus" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Add Model Qustion</p>
                                        </a>
                                    </li>
