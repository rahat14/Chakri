...
?>
    ...
    if (isset($_POST['submit'])) {
        ...
        $image = 'https://latestcircular.com/chakri_admin/all_images/' . $p_cat_image;
        echo $image;
        $p_id = $id ; 
        ...
        // load data 
        $insert_p_cat = "insert into notification_db(title , description , date  , post_id, post_type) values ('$p_cat_title' , '$p_cat_desc' , '$date' , $p_id  , $type)";
