...
?>
                    ...
                    <form class="form-horizontral" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea type="text" 
                               rows="10" cols="10"
                                name="share_text" class="form-control" required placeholder="Add Text"><?php echo $share_text; ?></textarea>
    ...
    if (isset($_POST['submit'])) {
        ...
        $insert_store = "UPDATE  job_prep_db  set  title ='$store_title' ,image ='$store_image' ,pdf ='$circular_pdf' ,description ='$store_desc' , cat_id =$store_merchant_id , sub_cat_id  = $store_sub_cat_id , keywords ='$keywords', image2 = '$store_image2' , image3 = '$store_image3' , share_text = '$share_text' where  id = $edit_id";
