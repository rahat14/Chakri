...
?>
  ...
  <script>
                    ...
                    <form class="form-horizontral" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="store_desc" class="form-control" rows="10" cols="10" placeholder="Write The Description"></textarea>
                        ...
                        <!-- form-group Ends -->
                            ...
                            <label class="col-md-6 control-label"> Text For Share Button : </label>

                            <div class="col-md-12">


                                <textarea type="text" rows="9" cols="12" name="share_text" class="form-control" required placeholder="Add Text"></textarea>
    ...
    if (isset($_POST['submit'])) {
        ...
        $insert_store = "insert into job_prep_db (title ,image,pdf ,description , cat_id , sub_cat_id ,date , keywords , image2 ,image3,share_text , post_type) values ('$store_title','$store_image', '$circular_pdf','$store_desc' , '$store_merchant_id', $sub_cat ,'$date' , '$keywords' , '$store_image2'  , '$store_image3' , '$share_text' , 555)";
